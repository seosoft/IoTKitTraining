...
1. [組み込み開発の基礎とデジタル出力](./1_Digital_IO.md)
2. [外部の LED 点滅](./2_BlinkExtLed.md)
...
> ただし Grove Beginner Kit 以外のボードやデバイスを使う場合のインストール手順や結線方法などは、このコンテンツでは触れません。各自で適切な手順で行ってください。